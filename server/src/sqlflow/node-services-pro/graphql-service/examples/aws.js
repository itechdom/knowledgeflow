...
`}
  ...
  ${{
    Queue: {
      ...
      Attributes: {
        resolve: root => {
          ...
          return sqs
            .getQueueAttributesAsync(params)
    ...
    Message: {
      MD5OfMessageBody: {
        resolve: root => {
          return root.MD5OfMessageBody || root.MD5OfBody;
        }
      }
    },
    Topic: {
    ...
    Queries: {
      ...
      listQueues: {
        resolve: (root, { QueueNamePrefix }) => {
          return sqs
            .listQueuesAsync(QueueNamePrefix)
    ...
    Mutations: {
      ...
      deleteMessage: {
        resolve: (obj, { QueueUrl, ReceiptHandle }) => {
          ...
          return sqs
            .deleteMessageAsync(params)
            .then(result => result.ResponseMetadata.RequestId);
        }
      },
      deleteQueue: {
        resolve: (obj, { QueueUrl }) => {
