...
const Orders = ({ config, ordersModel, permissionsModel, formsModel }) => {
  ...
  const ordersApi = crudService({ Model: ordersModel, crudDomainLogic });
 ...
 */
  ...
  return [ordersApi, vizApi, formsApi];
};
